...
const traducciones = {
  es: {
    ...
    portada_titulo: 'SERVICIOS PROFESIONALES DE ALICATADO EN VALENCIA Y ALREDEDORES',
    ...
    contacto_telefono: 'Telefono: +34 643 625981',
    ...
    pie_telefono: 'Telefono: +34 643 625981',
    pie_propietario: 'Propietario y maestro alicatador: Edmond Çela',
  ...
  ru: {
    ...
    portada_titulo: 'ПРОФЕССИОНАЛЬНЫЕ УСЛУГИ ПО УКЛАДКЕ ПЛИТКИ В ВАЛЕНСИИ И ОКРЕСТНОСТЯХ',
    ...
    contacto_telefono: 'Телефон: +34 643 625981',
    ...
    pie_telefono: 'Телефон: +34 643 625981',
    pie_propietario: 'Владелец и мастер-плиточник: Edmond Çela',
